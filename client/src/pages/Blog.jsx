    ...
    <div className='relative'>
      ...
      <div className='mx-5 max-w-5xl md:mx-auto my-10 mt-6'>
          ...
          <div className='max-w-3xl mx-auto'>
              ...
              <form onSubmit={addCommment} className='flex flex-col items-start gap-4 max-w-lg'>
                ...
                <textarea placeholder='Comment' required className='w-full p-2 border border-gray-300 rounded outline-none h-48' onChange={(e) => setContent(e.target.value)} value={content}></textarea>
                <button type='submit' className='bg-primary text-white rounded p-2 px-8 hover:scale-102 transition-all cursor-pointer'>Post</button>
              </form>
          </div>
